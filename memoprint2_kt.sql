...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2016 at 07:39 AM
...
(1, 'Default', '', 1, '2016-04-19 17:53:03', '2016-04-19 17:53:03');
...
INSERT INTO `oc_blog_article` (`article_id`, `author_id`, `article_list_gallery_display`, `sort_order`, `image`, `status`, `status_comments`, `date_added`, `date_published`, `date_updated`) VALUES
(1, 1, 'SLIDER', 0, 'catalog/logo.png', 1, 1, '2016-05-04 12:40:54', '2016-05-04 12:40:54', '2016-05-04 12:40:54'),
(2, 1, 'SLIDER', 0, 'catalog/logo.png', 1, 1, '2016-05-04 12:48:21', '2016-05-04 12:48:21', '2016-05-04 12:48:21');
...
CREATE TABLE `oc_blog_article_description` (
  `article_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
INSERT INTO `oc_blog_article_description` (`article_id`, `language_id`, `title`, `description`, `content`, `tags`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(1, 2, 'test', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '', 'test', '', ''),
(2, 2, 'test', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'test,test2', 'test', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `oc_blog_article_gallery`
--

CREATE TABLE `oc_blog_article_gallery` (
  `article_item_id` int(11) NOT NULL,
  `article_id` int(11) NOT NULL,
  `path` varchar(512) DEFAULT NULL,
  `width` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `height` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `type` enum('IMG','YOUTUBE','SOUNDCLOUD') DEFAULT 'IMG',
  `output` text,
  `sort_order` int(3) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `oc_blog_article_related` (
  `article_id` int(11) NOT NULL,
...
CREATE TABLE `oc_blog_article_to_category` (
  `article_id` int(11) NOT NULL,
...
CREATE TABLE `oc_blog_article_to_store` (
  `article_id` int(11) NOT NULL,
...
INSERT INTO `oc_blog_author` (`author_id`, `name`, `image`, `sort_order`) VALUES
(1, 'admin', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `oc_blog_author_description`
--

CREATE TABLE `oc_blog_author_description` (
  `author_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `description` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
--
-- Dumping data for table `oc_blog_author_description`
--

INSERT INTO `oc_blog_author_description` (`author_id`, `language_id`, `description`) VALUES
(1, 2, '&lt;p&gt;&lt;br&gt;&lt;/p&gt;');
...
INSERT INTO `oc_blog_category` (`category_id`, `image`, `parent_id`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
(1, '', 0, 0, 0, 1, '2016-05-04 17:41:51', '2016-05-04 17:41:51');
...
CREATE TABLE `oc_blog_product_related` (
  `article_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
--
-- Table structure for table `oc_blog_settings`
--
...
--
-- Dumping data for table `oc_blog_settings`
--

INSERT INTO `oc_blog_settings` (`settings_id`, `gallery_image_width`, `gallery_image_height`, `gallery_youtube_width`, `gallery_youtube_height`, `gallery_soundcloud_width`, `gallery_soundcloud_height`, `gallery_related_article_width`, `gallery_related_article_height`, `article_list_template`, `article_detail_template`, `article_related_template`, `article_page_limit`, `article_related_per_row`, `article_related_status`, `article_scroll_related`, `product_related_per_row`, `product_related_status`, `product_scroll_related`, `product_per_row`, `pagination_type`, `comments_engine`, `disqus_name`, `facebook_id`, `comments_approval`, `author_description`, `date_modified`) VALUES
(1, 1000, 400, 1000, 400, 1000, 140, 262, 343, 'grid_3_columns_with_thumbnails.tpl', 'default.tpl', 'type_2.tpl', 10, 3, 1, 0, 4, 1, 0, 3, 'AJAX', 'LOCAL', 'intellect', '185688598160957', 1, 1, '0000-00-00 00:00:00');
...
(4, 'บาท', 'THB', '', '฿', '2', 1.00000000, 1, '2016-05-04 09:11:28');
...
(18, 'module', 'featured'),
(19, 'module', 'slideshow'),
(20, 'module', 'semi_footer'),
(21, 'module', 'advanced_grid'),
(22, 'module', 'blog_category'),
(23, 'module', 'blog_latest'),
(24, 'module', 'blog'),
(25, 'module', 'blog_popular'),
(26, 'module', 'blog_tags'),
(27, 'module', 'blog_related_post'),
(28, 'module', 'blog_search'),
(29, 'module', 'breadcrumb_background_image'),
(30, 'module', 'camera_slider'),
(31, 'module', 'carousel_item'),
(32, 'module', 'category_wall'),
(33, 'module', 'cookie'),
(34, 'module', 'custom_module'),
(35, 'module', 'faq'),
(36, 'module', 'fastor'),
(37, 'module', 'filter_product'),
(38, 'module', 'full_screen_background_slider'),
(39, 'module', 'header_notice'),
(40, 'module', 'megamenu_manager_links'),
(41, 'module', 'megamenu'),
(42, 'module', 'newsletter'),
(43, 'module', 'popup'),
(44, 'module', 'product_blocks'),
(45, 'module', 'product_questions'),
(46, 'module', 'product_tabs'),
(47, 'module', 'revolution_slider'),
(48, 'module', 'revslideropencart'),
(49, 'module', 'semi_video_center');
...
(5, 'Thailand', 'ประเทศไทย ทุกจังหวัด', '0000-00-00 00:00:00', '2016-04-19 18:16:06');
...
(8, 2, 'วิดีโอตัวอย่างการสอน', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'วิดีโอตัวอย่างการสอน', '', ''),
(7, 2, 'ข่าวสาร', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'ข่าวสาร', '', ''),
(4, 2, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', '', '', ''),
...
(20, 0, 0, 3, 'catalog/toys3/icon-phone.png', 'a:1:{i:2;s:167:"ติดต่อเรา &lt;span style=&quot;font-size: 20px;font-weight: 800;color: #116ccc;line-height: 19px;padding-left: 2px&quot;&gt;500-123-5100&lt;/span&gt;";}', '#', 'a:1:{i:2;s:0:"";}', 'a:1:{i:2;s:0:"";}', '', '', '', 0, 0, 1, 1, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:1:{i:2;s:0:"";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:1:{i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(4, 0, 0, 0, '', 'a:1:{i:2;s:24:"หน้าหลัก";}', '', 'a:1:{i:2;s:0:"";}', 'a:1:{i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '400px', 1, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:1:{i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:1:{i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(5, 0, 0, 1, '', 'a:1:{i:2;s:21:"ข่าวสาร";}', 'news', 'a:1:{i:2;s:0:"";}', 'a:1:{i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:1:{i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:1:{i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(6, 0, 0, 2, '', 'a:1:{i:2;s:27:"ติดต่อเรา";}', 'contact', 'a:1:{i:2;s:0:"";}', 'a:1:{i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:1:{i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:1:{i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(21, 1, 13, 1, '', 'a:1:{i:2;s:4:"test";}', '/', 'a:1:{i:2;s:0:"";}', 'a:1:{i:2;s:4:"test";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:1:{i:2;s:0:"";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:1:{i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(13, 1, 0, 0, '', 'a:2:{i:1;s:4:"Eyes";i:2;s:4:"Eyes";}', 'index.php?route=product/category&amp;path=25', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '190px', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(14, 1, 0, 2, '', 'a:2:{i:1;s:4:"Lips";i:2;s:4:"Lips";}', 'index.php?route=product/category&amp;path=18', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '190px', 0, '', 'top right', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(15, 1, 0, 3, '', 'a:2:{i:1;s:5:"Nails";i:2;s:5:"Nails";}', 'index.php?route=product/category&amp;path=25', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '795px', 0, '', 'top right', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(16, 1, 0, 4, '', 'a:2:{i:1;s:4:"Face";i:2;s:4:"Face";}', 'index.php?route=product/category&amp;path=25', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(17, 1, 0, 5, '', 'a:2:{i:1;s:9:"Skincares";i:2;s:9:"Skincares";}', 'index.php?route=account/wishlist', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}'),
(18, 1, 0, 6, '', 'a:2:{i:1;s:7:"Brushes";i:2;s:7:"Brushes";}', 'index.php?route=information/contact', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', 'a:2:{i:1;s:0:"";i:2;s:0:"";}', '', '', NULL, 0, 0, 0, 0, '100%', 0, '', 'top left', 'no-repeat', 4, 0, 'a:4:{s:4:"html";a:1:{s:4:"text";a:2:{i:1;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";i:2;s:29:"&lt;p&gt;&lt;br&gt;&lt;/p&gt;";}}s:7:"product";a:4:{s:2:"id";s:0:"";s:4:"name";s:0:"";s:5:"width";s:3:"400";s:6:"height";s:3:"400";}s:10:"categories";a:7:{s:10:"categories";a:0:{}s:7:"columns";s:1:"1";s:7:"submenu";s:1:"1";s:14:"image_position";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";s:15:"submenu_columns";s:1:"1";}s:8:"products";a:5:{s:7:"heading";a:2:{i:1;s:0:"";i:2;s:0:"";}s:8:"products";a:0:{}s:7:"columns";s:1:"1";s:11:"image_width";s:0:"";s:12:"image_height";s:0:"";}}');
...
--
-- Table structure for table `oc_mega_menu_modules`
--

CREATE TABLE `oc_mega_menu_modules` (
  `id` int(11) UNSIGNED NOT NULL,
  `name` text
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `oc_mega_menu_modules`
--
...
(44, 'Product 17', '', '', '', '', '', '', '', 1000, 5, 'catalog/demo/macbook_air_1.jpg', 8, 1, '1000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 4, '2009-02-03 21:08:00', '2011-09-30 01:05:53'),
...
(745, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(746, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(94, 0, 'voucher', 'voucher_sort_order', '8', 0),
(95, 0, 'voucher', 'voucher_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(104, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(744, 0, 'config', 'config_file_max_size', '300000', 0),
(739, 0, 'config', 'config_compression', '0', 0),
(740, 0, 'config', 'config_secure', '0', 0),
(741, 0, 'config', 'config_password', '1', 0),
(742, 0, 'config', 'config_shared', '0', 0),
(743, 0, 'config', 'config_encryption', '', 0),
(737, 0, 'config', 'config_seo_url', '0', 0),
(738, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(735, 0, 'config', 'config_mail_alert', '', 0),
...
(727, 0, 'config', 'config_ftp_status', '0', 0),
(728, 0, 'config', 'config_mail_protocol', 'mail', 0),
(726, 0, 'config', 'config_ftp_root', '', 0),
(725, 0, 'config', 'config_ftp_password', '', 0),
(723, 0, 'config', 'config_ftp_port', '21', 0),
(724, 0, 'config', 'config_ftp_username', '', 0),
(722, 0, 'config', 'config_ftp_hostname', 'localhost', 0),
(721, 0, 'config', 'config_image_location_height', '50', 0),
(720, 0, 'config', 'config_image_location_width', '268', 0),
(719, 0, 'config', 'config_image_cart_height', '47', 0),
(718, 0, 'config', 'config_image_cart_width', '47', 0),
(717, 0, 'config', 'config_image_wishlist_height', '47', 0),
(716, 0, 'config', 'config_image_wishlist_width', '47', 0),
(715, 0, 'config', 'config_image_compare_height', '90', 0),
(714, 0, 'config', 'config_image_compare_width', '90', 0),
(713, 0, 'config', 'config_image_related_height', '80', 0),
(712, 0, 'config', 'config_image_related_width', '80', 0),
(711, 0, 'config', 'config_image_additional_height', '74', 0),
(710, 0, 'config', 'config_image_additional_width', '74', 0),
(709, 0, 'config', 'config_image_product_height', '228', 0),
(708, 0, 'config', 'config_image_product_width', '228', 0),
(707, 0, 'config', 'config_image_popup_height', '500', 0),
(706, 0, 'config', 'config_image_popup_width', '500', 0),
(705, 0, 'config', 'config_image_thumb_height', '228', 0),
(704, 0, 'config', 'config_image_thumb_width', '228', 0),
(703, 0, 'config', 'config_image_category_height', '80', 0),
(702, 0, 'config', 'config_image_category_width', '80', 0),
(701, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(700, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(698, 0, 'config', 'config_captcha', '', 0),
(699, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(697, 0, 'config', 'config_return_status_id', '2', 0),
(696, 0, 'config', 'config_return_id', '0', 0),
(695, 0, 'config', 'config_affiliate_mail', '0', 0),
(694, 0, 'config', 'config_affiliate_id', '4', 0),
(693, 0, 'config', 'config_affiliate_commission', '5', 0),
(692, 0, 'config', 'config_affiliate_auto', '0', 0),
(691, 0, 'config', 'config_affiliate_approval', '0', 0),
(690, 0, 'config', 'config_stock_checkout', '0', 0),
(689, 0, 'config', 'config_stock_warning', '0', 0),
(688, 0, 'config', 'config_stock_display', '0', 0),
(687, 0, 'config', 'config_api_id', '1', 0),
(686, 0, 'config', 'config_order_mail', '0', 0),
(685, 0, 'config', 'config_fraud_status_id', '7', 0),
(684, 0, 'config', 'config_complete_status', '["5","3"]', 1),
(683, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1),
(682, 0, 'config', 'config_order_status_id', '1', 0),
(681, 0, 'config', 'config_checkout_id', '5', 0),
(680, 0, 'config', 'config_checkout_guest', '1', 0),
(679, 0, 'config', 'config_cart_weight', '1', 0),
(678, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(677, 0, 'config', 'config_account_mail', '0', 0),
(676, 0, 'config', 'config_account_id', '3', 0),
(674, 0, 'config', 'config_customer_price', '0', 0),
(675, 0, 'config', 'config_login_attempts', '5', 0),
(673, 0, 'config', 'config_customer_group_display', '["1"]', 1),
(672, 0, 'config', 'config_customer_group_id', '1', 0),
(671, 0, 'config', 'config_customer_online', '0', 0),
(670, 0, 'config', 'config_tax_customer', 'shipping', 0),
(668, 0, 'config', 'config_tax', '1', 0),
(669, 0, 'config', 'config_tax_default', 'shipping', 0),
(653, 0, 'config', 'config_language', 'th', 0),
(654, 0, 'config', 'config_admin_language', 'th', 0),
(655, 0, 'config', 'config_currency', 'THB', 0),
(656, 0, 'config', 'config_currency_auto', '1', 0),
(657, 0, 'config', 'config_length_class_id', '1', 0),
(658, 0, 'config', 'config_weight_class_id', '1', 0),
(659, 0, 'config', 'config_product_count', '1', 0),
(660, 0, 'config', 'config_product_limit', '15', 0),
(661, 0, 'config', 'config_product_description_length', '100', 0),
(662, 0, 'config', 'config_limit_admin', '20', 0),
(663, 0, 'config', 'config_review_status', '1', 0),
(664, 0, 'config', 'config_review_guest', '1', 0),
(665, 0, 'config', 'config_review_mail', '0', 0),
(666, 0, 'config', 'config_voucher_min', '1', 0),
(667, 0, 'config', 'config_voucher_max', '1000', 0),
(649, 0, 'config', 'config_open', '', 0),
(650, 0, 'config', 'config_comment', '', 0),
(651, 0, 'config', 'config_country_id', '209', 0),
(652, 0, 'config', 'config_zone_id', '3192', 0),
(638, 0, 'config', 'config_meta_keyword', '', 0),
(639, 0, 'config', 'config_template', 'fastor', 0),
(640, 0, 'config', 'config_layout_id', '4', 0),
(641, 0, 'config', 'config_name', 'Krungthai', 0),
(642, 0, 'config', 'config_owner', 'Your Name', 0),
(643, 0, 'config', 'config_address', 'Address 1', 0),
(644, 0, 'config', 'config_geocode', '', 0),
(645, 0, 'config', 'config_email', 'admin@localhost', 0),
(646, 0, 'config', 'config_telephone', '123456789', 0),
(647, 0, 'config', 'config_fax', '', 0),
(648, 0, 'config', 'config_image', '', 0),
(637, 0, 'config', 'config_meta_description', 'My Store', 0),
(636, 0, 'config', 'config_meta_title', 'Krungthai', 0),
(747, 0, 'config', 'config_error_display', '1', 0),
(748, 0, 'config', 'config_error_log', '1', 0),
(749, 0, 'config', 'config_error_filename', 'error.log', 0),
(753, 0, 'fastor_skin', 'fastor_skin', 'Krungthai', 0),
(778, 0, 'select_demo', 'select_demo', '67', 0),
(808, 0, 'blog_latest', 'blog_latest_module', '{"1":{"heading_title":{"2":""},"layout_id":"15","position":"content_top","template":"news.tpl","status":"1","thumb_width":"180","thumb_height":"180","articles_limit":"4","sort_order":"1"}}', 1),
(813, 0, 'semi_video_center', 'semi_video_center_module', '[{"position":"content_top","layout_id":"16","sort_order":"","column_class":"col-md-4","show_item":"4","status":"1","links":{"5729eaa7c485b":{"uniqid":"5729eaa7c485b","link_video":"https:\\/\\/www.youtube.com\\/watch?v=dixqHen_FxQ","status":"1","sort_order":""},"5729e9b68e5fc":{"uniqid":"5729e9b68e5fc","link_video":"https:\\/\\/www.youtube.com\\/watch?v=dixqHen_FxQ","status":"1","sort_order":""},"5729eaa43d65e":{"uniqid":"5729eaa43d65e","link_video":"https:\\/\\/www.youtube.com\\/watch?v=dixqHen_FxQ","status":"1","sort_order":""}}}]', 1),
(795, 0, 'semi_footer', 'semi_footer_module', '{"1":{"company_name":{"2":""},"address":{"2":""},"operation_time":{"2":""},"email_title":{"2":""},"copyright":{"2":"Copyright \\u00a9 2016"},"position":"footer","layout_id":"99999","logo_image":"catalog\\/logo.png","email":"","phone1":"","phone2":"","fax":"","facebook":"","line":"","instagram":"","youtube":"","sort_order":"","status":"1"}}', 1),
(757, 0, 'filter_product', 'filter_product_module', '[{"tabs":{"1":{"heading":{"1":"Featured","2":"Featured"},"title":"products","product":"","products":"30,47,28,41,43,45","category":"","categories":""}},"carousel":"0","width":"155","height":"155","itemsperpage":"6","cols":"1","limit":"6","layout_id":"1","position":"preface_fullwidth","status":"1","sort_order":"3"},{"tabs":{"2":{"heading":{"1":"Latest products","2":"Latest products"},"title":"products","product":"s","products":"42,43,44,45,29,46","category":"","categories":""}},"carousel":"0","width":"155","height":"155","itemsperpage":"6","cols":"1","limit":"6","layout_id":"1","position":"preface_fullwidth","status":"1","sort_order":"5"}]', 1),
(797, 0, 'custom_module', 'custom_module_module', '{"1":{"type":"2","block_heading":{"2":""},"block_content":{"2":"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;"},"html":{"2":"&lt;div class=&quot;row banners banners-with-padding-30&quot;&gt;\\r\\n     &lt;div class=&quot;col-sm-8&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-01.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-02.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;\\r\\n\\r\\n&lt;div class=&quot;row banners banners-with-padding-30&quot;&gt;\\r\\n     &lt;div class=&quot;col-sm-5&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-03.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-7&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-04.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;"},"layout_id":"1","position":"preface_fullwidth","status":"1","sort_order":"1"},"2":{"type":"2","block_heading":{"2":""},"block_content":{"2":"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;"},"html":{"2":"&lt;div class=&quot;container hidden-xs hidden-sm&quot;&gt;&lt;div class=&quot;toys3-categories clearfix&quot;&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/action-figures.png) top right no-repeat&quot;&gt;Action&lt;br&gt;Figures&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/clothes.png) top left no-repeat&quot;&gt;Clothes&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/dolls.png) top left no-repeat&quot;&gt;Dolls&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/electronics.png) top left no-repeat&quot;&gt;Electronics&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/games-and-puzzles.png) top left no-repeat&quot;&gt;Games&lt;br&gt;&amp; Puzzles&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/learning-toys.png) top left no-repeat&quot;&gt;Learning&lt;br&gt;Toys&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/stuffed-animals.png) top left no-repeat&quot;&gt;Stuffed&lt;br&gt;animals&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div&gt;&lt;a href=&quot;index.php?route=product\\/category&amp;path=20&quot; style=&quot;background: url(image\\/catalog\\/toys3\\/video-games.png) top right no-repeat&quot;&gt;Video&lt;br&gt;Games&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;&lt;\\/div&gt;"},"layout_id":"99999","position":"slideshow","status":"1","sort_order":"0"},"3":{"type":"2","block_heading":{"2":""},"block_content":{"2":"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;"},"html":{"2":"&lt;div class=&quot;row banners&quot;&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-05.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-06.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-07.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;"},"layout_id":"1","position":"preface_fullwidth","status":"0","sort_order":"4"},"4":{"type":"2","block_heading":{"2":""},"block_content":{"2":"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;"},"html":{"2":"&lt;div class=&quot;row banners banners-with-padding-30&quot; style=&quot;margin-bottom: 10px&quot;&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-05.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-06.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;col-sm-4&quot;&gt;&lt;a href=&quot;#&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-07.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;&lt;\\/div&gt;\\r\\n&lt;\\/div&gt;"},"layout_id":"1","position":"content_bottom","status":"0","sort_order":"10"}}', 1),
(804, 0, 'advanced_grid', 'advanced_grid_module', '{"1":{"custom_class":"","margin_top":"0","margin_right":"0","margin_bottom":"0","margin_left":"0","padding_top":"0","padding_right":"0","padding_bottom":"0","padding_left":"0","force_full_width":"0","background_color":"","background_image_type":"0","background_image":"","background_image_position":"top center","background_image_repeat":"no-repeat","background_image_attachment":"scroll","layout_id":"99999","position":"footer","status":"0","sort_order":"","disable_on_mobile":"0","column":{"1":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"1","module":{"1":{"status":"1","sort":"1","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Electronics"},"limit":"6","array":{"1":{"name":{"2":"Camera, Photo &amp; Video"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"2":{"name":{"2":"Cell Phones &amp; Accessories"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"3":{"name":{"2":"Laptops &amp; Notebooks"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"4":{"name":{"2":"Musical Instruments"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"5":{"name":{"2":"Tablets"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"6":{"name":{"2":"TV &amp; Video"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"}}}},"2":{"status":"1","sort":"2","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Clothing &amp; shoes"},"limit":"7","array":{"7":{"name":{"2":"Baby"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"8":{"name":{"2":"Boys"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"9":{"name":{"2":"Girls"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"10":{"name":{"2":"Men"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"11":{"name":{"2":"Uniforms, Work &amp; Safety"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"12":{"name":{"2":"Shoes"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"},"13":{"name":{"2":"Women"},"url":"index.php?route=product\\/category&amp;path=20","sort":"7"}}}}}},"2":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"2","module":{"1":{"status":"1","sort":"1","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Home"},"limit":"6","array":{"14":{"name":{"2":"Accessories"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"15":{"name":{"2":"Arts"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"16":{"name":{"2":"Bedding &amp; Bath"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"17":{"name":{"2":"Furniture"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"18":{"name":{"2":"Kitchen &amp; Dining"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"19":{"name":{"2":"Living room"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"}}}},"2":{"status":"1","sort":"2","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Sports &amp; Outdoors"},"limit":"6","array":{"20":{"name":{"2":"Exercise &amp; Fitness"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"21":{"name":{"2":"Leisure Sports"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"22":{"name":{"2":"Running"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"23":{"name":{"2":"Team Sports"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"24":{"name":{"2":"Tennis &amp; Racquet Sports"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"25":{"name":{"2":"Yoga"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"}}}}}},"3":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"3","module":{"1":{"status":"1","sort":"1","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Beauty &amp; health"},"limit":"6","array":{"26":{"name":{"2":"Bath &amp; Body Care"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"27":{"name":{"2":"Fragrance"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"28":{"name":{"2":"Hair Care"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"29":{"name":{"2":"Makeup"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"30":{"name":{"2":"Skin Care"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"31":{"name":{"2":"Tools &amp; Accessories"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"}}}},"2":{"status":"1","sort":"2","type":"links","links":{"module_layout":"default.tpl","title":{"2":"Automotive"},"limit":"6","array":{"32":{"name":{"2":"Accessories"},"url":"index.php?route=product\\/category&amp;path=20","sort":"1"},"33":{"name":{"2":"Electronics &amp; GPS"},"url":"index.php?route=product\\/category&amp;path=20","sort":"2"},"34":{"name":{"2":"Motorcycle"},"url":"index.php?route=product\\/category&amp;path=20","sort":"3"},"35":{"name":{"2":"Parts"},"url":"index.php?route=product\\/category&amp;path=20","sort":"4"},"36":{"name":{"2":"Tires &amp; Wheels"},"url":"index.php?route=product\\/category&amp;path=20","sort":"5"},"37":{"name":{"2":"Tools"},"url":"index.php?route=product\\/category&amp;path=20","sort":"6"}}}}}},"4":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"4","module":{"1":{"status":"1","sort":"1","type":"html","html":{"2":"&lt;div class=&quot;footer-about-us market-about-us&quot;&gt;\\r\\n     &lt;img src=&quot;image\\/catalog\\/toys3\\/logo-footer.png&quot; alt=&quot;Fastor&quot;&gt;\\r\\n     &lt;p&gt;PO Box 16122 Collins Street &lt;br&gt;Victoria 8007 Australia&lt;\\/p&gt;\\r\\n     &lt;ul class=&quot;social-icons&quot;&gt;\\r\\n          &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-twitter&quot;&gt;&lt;\\/i&gt;&lt;\\/a&gt;&lt;\\/li&gt;\\r\\n          &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-facebook&quot;&gt;&lt;\\/i&gt;&lt;\\/a&gt;&lt;\\/li&gt;\\r\\n          &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-youtube-play&quot;&gt;&lt;\\/i&gt;&lt;\\/a&gt;&lt;\\/li&gt;\\r\\n          &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-github&quot;&gt;&lt;\\/i&gt;&lt;\\/a&gt;&lt;\\/li&gt;\\r\\n          &lt;li&gt;&lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-behance&quot;&gt;&lt;\\/i&gt;&lt;\\/a&gt;&lt;\\/li&gt;\\r\\n     &lt;\\/ul&gt;\\r\\n&lt;\\/div&gt;"}},"2":{"status":"1","sort":"2","type":"html","html":{"2":"&lt;a href=&quot;#&quot; style=&quot;display: block;margin-top: 50px&quot; class=&quot;responsive-margin-top-30&quot;&gt;&lt;img src=&quot;image\\/catalog\\/toys3\\/banner-08.jpg&quot; alt=&quot;Banner&quot;&gt;&lt;\\/a&gt;"}}}},"5":{"status":"1","width":"12","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"5","module":{"1":{"status":"1","sort":"1","type":"html","html":{"2":"Powered by OpenCart."}}}}}},"2":{"custom_class":"responsive-margin-top-45","margin_top":"60","margin_right":"0","margin_bottom":"0","margin_left":"0","padding_top":"0","padding_right":"0","padding_bottom":"0","padding_left":"0","force_full_width":"1","background_color":"#116ccc","background_image_type":"1","background_image":"catalog\\/toys3\\/bg-parallax.jpg","background_image_position":"top center","background_image_repeat":"no-repeat","background_image_attachment":"scroll","layout_id":"1","position":"content_bottom","status":"0","sort_order":"0","disable_on_mobile":"0","column":{"6":{"status":"1","width":"12","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"1","module":{"1":{"status":"1","sort":"1","type":"html","html":{"2":"&lt;div class=&quot;toys3-parallax&quot;&gt;\\r\\n     &lt;div class=&quot;first-heading&quot;&gt;INSPIRATION&lt;br&gt;AREA&lt;\\/div&gt;\\r\\n     &lt;div class=&quot;second-heading&quot;&gt;Need some inspiration&lt;br&gt;for your children room?&lt;\\/div&gt;\\r\\n     &lt;a href=&quot;#&quot; class=&quot;button btn-default&quot;&gt;Read more&lt;\\/a&gt;\\r\\n&lt;\\/div&gt;"}}}}}},"3":{"custom_class":"","margin_top":"0","margin_right":"0","margin_bottom":"0","margin_left":"0","padding_top":"0","padding_right":"0","padding_bottom":"0","padding_left":"0","force_full_width":"0","background_color":"","background_image_type":"0","background_image":"","background_image_position":"top left","background_image_repeat":"no-repeat","background_image_attachment":"scroll","layout_id":"1","position":"content_bottom","status":"0","sort_order":"1","disable_on_mobile":"0","column":{"7":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"1","module":{"1":{"status":"1","sort":"1","type":"products","products":{"module_layout":"toys3_products.tpl","title":{"2":"Clothes"},"get_products_from":"products","product":"","products":"28,42","category":"","categories":"","width":"103","height":"103","limit":"2"}}}},"8":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"2","module":{"1":{"status":"1","sort":"1","type":"products","products":{"module_layout":"toys3_products.tpl","title":{"2":"Electronics"},"get_products_from":"products","product":"","products":"43,45","category":"","categories":"","width":"103","height":"103","limit":"2"}}}},"9":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"3","module":{"1":{"status":"1","sort":"1","type":"products","products":{"module_layout":"toys3_products.tpl","title":{"2":"Learning Toys"},"get_products_from":"products","product":"","products":"47,28","category":"","categories":"","width":"103","height":"103","limit":"2"}}}},"10":{"status":"1","width":"3","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"4","module":{"1":{"status":"1","sort":"1","type":"products","products":{"module_layout":"toys3_products.tpl","title":{"2":"Stuffed Animals"},"get_products_from":"products","product":"","products":"46,30","category":"","categories":"","width":"103","height":"103","limit":"2"}}}}}},"4":{"custom_class":"responsive-margin-top-45","margin_top":"60","margin_right":"0","margin_bottom":"0","margin_left":"0","padding_top":"160","padding_right":"0","padding_bottom":"160","padding_left":"0","force_full_width":"1","background_color":"","background_image_type":"1","background_image":"catalog\\/home\\/home_bnner-4.png","background_image_position":"top center","background_image_repeat":"no-repeat","background_image_attachment":"scroll","layout_id":"1","position":"content_bottom","status":"1","sort_order":"4","disable_on_mobile":"1","column":{"11":{"status":"1","width":"12","disable_on_mobile":"0","width_xs":"1","width_sm":"1","width_md":"1","width_lg":"1","sort":"1","module":{"1":{"status":"1","sort":"1","type":"newsletter","newsletter":{"module_layout":"toys3_newsletter_custom.tpl","title":{"2":"Subscribe&lt;br&gt;our newsletter"},"text":{"2":"Sign in to our newsletter and receive coupon"},"input_placeholder":{"2":"E-mail"},"subscribe_text":{"2":"Ok"},"unsubscribe_text":{"2":""}}}}}}}}', 1),
(809, 0, 'megamenu', 'megamenu_module', '[{"module_id":0,"layout_id":"99999","position":"menu","status":"1","display_on_mobile":"0","sort_order":1,"orientation":"0","search_bar":0,"navigation_text":{"2":""},"home_text":{"2":""},"full_width":"1","home_item":"disabled","animation":"shift-up","animation_time":200,"status_cache":0,"cache_time":1},{"module_id":"1","layout_id":"99999","position":"menu","status":"1","display_on_mobile":"0","sort_order":0,"orientation":"1","search_bar":0,"navigation_text":{"2":"\\u0e1b\\u0e23\\u0e30\\u0e40\\u0e20\\u0e17"},"home_text":{"2":""},"full_width":"0","home_item":"disabled","animation":"shift-left","animation_time":200,"status_cache":0,"cache_time":1}]', 1);
...
(844, 'information_id=7', 'news'),
(846, 'blog_category_id=1', ''),
(849, 'information_id=8', 'video');
...
(1, 1, 'admin', 'da0d069eeffd1224c4ce03b8deb61bdb0625e68c', 'h3etwSQcL', 'John', 'Doe', 'admin@localhost', '', '', '::1', 1, '2016-04-19 17:53:03');
...
(110, 209, 0, 5, '2016-04-19 18:16:06', '0000-00-00 00:00:00');
...
--
-- Indexes for table `oc_blog_article`
--
ALTER TABLE `oc_blog_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `oc_blog_article_description`
--
ALTER TABLE `oc_blog_article_description`
  ADD PRIMARY KEY (`article_id`,`language_id`),
  ADD KEY `name` (`title`);

--
-- Indexes for table `oc_blog_article_gallery`
--
ALTER TABLE `oc_blog_article_gallery`
  ADD PRIMARY KEY (`article_item_id`),
  ADD KEY `product_id` (`article_id`);

--
-- Indexes for table `oc_blog_article_related`
--
ALTER TABLE `oc_blog_article_related`
  ADD PRIMARY KEY (`related_id`,`article_id`);

--
-- Indexes for table `oc_blog_article_to_category`
--
ALTER TABLE `oc_blog_article_to_category`
  ADD PRIMARY KEY (`article_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `oc_blog_article_to_store`
--
ALTER TABLE `oc_blog_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indexes for table `oc_blog_author`
--
ALTER TABLE `oc_blog_author`
  ADD PRIMARY KEY (`author_id`);

--
-- Indexes for table `oc_blog_author_description`
--
ALTER TABLE `oc_blog_author_description`
...
--
-- Indexes for table `oc_blog_product_related`
--
ALTER TABLE `oc_blog_product_related`
  ADD PRIMARY KEY (`related_id`,`article_id`);

--
-- Indexes for table `oc_blog_settings`
--
ALTER TABLE `oc_blog_settings`
...
--
-- Indexes for table `oc_mega_menu_links`
--
ALTER TABLE `oc_mega_menu_links`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_mega_menu_modules`
--
ALTER TABLE `oc_mega_menu_modules`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oc_blog_article`
--
ALTER TABLE `oc_blog_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `oc_blog_article_gallery`
--
ALTER TABLE `oc_blog_article_gallery`
  MODIFY `article_item_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc_blog_author`
--
ALTER TABLE `oc_blog_author`
...
--
-- AUTO_INCREMENT for table `oc_mega_menu_links`
--
ALTER TABLE `oc_mega_menu_links`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `oc_mega_menu_modules`
--
ALTER TABLE `oc_mega_menu_modules`
